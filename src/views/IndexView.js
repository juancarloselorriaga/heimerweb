                ...
                <div data-w-id="c36e1957-5861-cd91-3fef-1dce0877fa99" className="af-class-div-fondo-modal-close">
                  <div className="af-class-div-container-modal">
                    ...
                    <div className="af-class-form-block w-form">
                      <form id="email-form-3" name="email-form-3" data-name="Email Form 3" className="af-class-form"><label htmlFor="name-3" className="af-class-field-label">Cliente</label><select id="field" name="field" className="af-class-select-field w-select"><option value="cliente1">Juan Carlos Elorriaga</option><option value="cliente2">Juan Ursúa</option><option value="seleccionar">Selecciona un cliente...</option></select></form>
                            ...
                            <div className="af-class-container-dashboard w-container">
                              ...
                              <div className="af-class-titulo-dashboard">
                                <div className="af-class-div-accesos-directos">
                                  <div data-w-id="42179216-cbe0-daa5-b273-b07f06f3714e" className="af-class-div-boton-navegacion"><img src="images/Nuevo-Cliente.svg" alt className="af-class-image-4" />
                                    <div className="af-class-texto-nav-dashboard">cliente</div>
                                  </div>
                                  <div className="af-class-div-boton-navegacion"><a href="nueva-orden.html" className="af-class-linkblockdash w-inline-block"><img src="images/Nueva-OC.svg" alt className="af-class-image-4" /><div className="af-class-texto-nav-dashboard">NUEVA&nbsp;O.C.</div></a></div>
                                  <div className="af-class-div-boton-navegacion"><a href="#" className="af-class-linkblockdash w-inline-block"><img src="images/Cerrar-Sesion.svg" alt className="af-class-image-4" /><div className="af-class-texto-nav-dashboard">Cerrar Sesión</div></a></div>
                                </div>
                              </div>
                            </div>
                          </div>
                                    ...
                                    <div className="af-class-lista-wrapper af-class-listado">
                                      ...
                                      <div className="af-class-list-row">
                                        ...
                                        <div className="af-class-accordion-content">
                                          ...
                                          <div className="af-class-list-column af-class-acciones">
                                            <h1 className="af-class-list-heading af-class-acciones">Acciones</h1>
                                            <div className="af-class-accionescontainer"><a href="ordenes-de-compra.html" ver="Ver Perfil" className="af-class-linkblockacciones w-inline-block"><img src="images/Ver.png" width={32} alt /></a><a href="#" editar="Editar Perfil" className="af-class-linkblockacciones af-class-editar-oc w-inline-block"><img src="images/Editar.png" alt /></a><a href="#" borrar="Borrar Cliente" className="af-class-linkblockacciones af-class-borrar w-inline-block"><img src="images/Borrar.png" alt /></a></div>
                                          </div>
                                        </div>
                                      </div>
                                      <div className="af-class-list-row">

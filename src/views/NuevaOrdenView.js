              ...
              <div className="af-class-div-fondo-modal">
                <div className="af-class-div-container-modal af-class-accesorios">
                  ...
                  <div className="af-class-modal af-class-nuevo">
                    <div id="w-node-aa6020a183a2" className="af-class-div-general-close af-class-nueva-orden"><a href="index.html" className="af-class-linkblock-div-general-close w-inline-block" /></div><a href="index.html" className="af-class-linkblock-div-general-close w-inline-block">
                    </a><div id="w-node-38cc82309031" className="af-class-div-fondo-modal af-class-nueva-orden"><a href="index.html" className="af-class-linkblock-div-general-close w-inline-block">
                      </a><div className="af-class-div-fondo-modal-close"><a href="index.html" className="af-class-linkblock-div-general-close w-inline-block" /><a href="index.html" className="af-class-linkblockreturn w-inline-block" /></div><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                        <h1 className="af-class-titulomodal">Nueva orden de compra</h1>
                      </a><div className="af-class-form-block w-form"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                        </a><form id="email-form" name="email-form" data-name="Email Form" className="af-class-form"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                          </a><div data-animation="cross" data-easing="ease-in-sine" data-hide-arrows={1} data-disable-swipe={1} data-duration={200} className="af-class-slider w-slider"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                            </a><div className="af-class-mask w-slider-mask"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                              ...
                              </a><div className="af-class-paso w-slide"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                </a><div className="af-class-div-container-form"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                  </a><div className="af-class-div-container-content"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                      <div className="af-class-div-titulo-pasos">
                                        <h1 className="af-class-titulomodal af-class-subtitulo">Agrega nuevos accesorios.</h1>
                                      </div>
                                    </a><div className="af-class-div-container-accesorios-nuevos"><a href="index.html" className="af-class-linkblockreturn w-inline-block"><a href="#" data-w-id="a226f9fe-9a77-1776-6a89-3b6c110ddbcc" className="af-class-boton af-class-principal af-class-popup af-class-content w-button">Agregar</a>
                                      </a><div className="af-class-div-accesorios"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                        </a><ul className="af-class-unordered-list w-list-unstyled"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                          </a><li className="af-class-list-item"><a href="index.html" className="af-class-linkblockreturn w-inline-block">
                                              <div className="af-class-item-accesorios-nuevos">Accesorio dummy 1</div></a><a href="#" className="af-class-boton-eliminar w-button">Eliminar</a></li>

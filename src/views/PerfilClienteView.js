                                ...
                                <div className="af-class-container-dashboard w-container">
                                  ...
                                  <div className="af-class-titulo-dashboard">
                                    <div className="af-class-div-accesos-directos">
                                      ...
                                      <div data-w-id="961417ed-24f6-3eb9-f431-033d905a4bcc" className="af-class-div-boton-navegacion"><img src="images/Nueva-Ubicación.svg" alt className="af-class-image-4" />
                                        <div className="af-class-texto-nav-dashboard">ubicación</div>
                                      </div>
                                      <div data-w-id="0cd60766-c934-6ba7-a13b-cb4e8ed6a8ad" className="af-class-div-boton-navegacion"><img src="images/Nueva-OC.svg" alt className="af-class-image-4" />
                                        <div className="af-class-texto-nav-dashboard">Ligar O.C.</div>
                                      </div>
                                      <div data-w-id="161afc42-8ed2-bd39-68de-26977364bf6e" className="af-class-div-boton-navegacion"><img src="images/Borrar.svg" alt className="af-class-image-4" />
